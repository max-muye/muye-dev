(() => {
  ...
  const text = {
    en: {
      ...
      thinkingH1: "Muye.dev is now v2.5.2.", versionList: "Version List", deployNotes: "Deploy Notes", nowThinkingHead: "Now Thinking About",
    },
    zh: {
      ...
      thinkingH1: "Muye.dev 现在是 v2.5.2。", versionList: "版本列表", deployNotes: "部署记录", nowThinkingHead: "现在在想",
    },
    ja: {
      ...
      thinkingH1: "Muye.dev は v2.5.2 です。", versionList: "バージョン一覧", deployNotes: "デプロイ記録", nowThinkingHead: "今考えていること",
    },
    ko: {
      ...
      thinkingH1: "Muye.dev는 v2.5.2입니다.", versionList: "버전 목록", deployNotes: "배포 기록", nowThinkingHead: "지금 생각하는 것",
    },
    es: {
      ...
      thinkingH1: "Muye.dev ahora es v2.5.2.", versionList: "Lista de versiones", deployNotes: "Notas de despliegue", nowThinkingHead: "Pensando ahora",
    },
  };
