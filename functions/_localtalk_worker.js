...
<body>
  ...
  <script>
    ...
    ["ja","ko","es","fr","de","pt","ru","ar"].forEach(code=>{dict[code]=dict.en});
    let lang=dict[localStorage.getItem("muye-lang")]?localStorage.getItem("muye-lang"):(localStorage.getItem("localtalk-lang")==="zh"?"zh":"en");let password="";let tab="messages";let selectedRoom=null;let messageRows=[];let signedRows=[];let privateRows=[];let ipv6Banned=false;let fastSpamMaster=true;let roomFastSpam={};
