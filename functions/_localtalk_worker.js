...
<body>
  ...
  <script>
    ...
    let lang=(localStorage.getItem("muye-lang")==="zh"||localStorage.getItem("localtalk-lang")==="zh")?"zh":"en";let currentMessages=[];let mySenderKey="";let quote=null;let publicBanned=false;let publicBanReason="";let uploadBusy=false;let sendBusy=false;let filePickUntil=0;
...
<body>
  ...
  <script>
    ...
    let lang=(localStorage.getItem("muye-lang")==="zh"||localStorage.getItem("localtalk-lang")==="zh")?"zh":"en";let password="";let tab="messages";let selectedRoom=null;let messageRows=[];let signedRows=[];let privateRows=[];let ipv6Banned=false;let fastSpamMaster=true;let roomFastSpam={};
...
<body>
  ...
  <script>
    ...
    const lang=(localStorage.getItem("muye-lang")==="zh"||localStorage.getItem("localtalk-lang")==="zh")?"zh":"en";
