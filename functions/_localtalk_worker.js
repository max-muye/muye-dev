...
<body>
  ...
  <script>
    ...
    function api(path){const parts=location.pathname.replace(/^\/+|\/+$/g,"").split("/");const signedRoom=parts[0]==="talk"&&parts[1]==="signed"?(parts[2]||""):"";return signedRoom?"/talk/signed/"+encodeURIComponent(signedRoom)+path:"/api/talk"+path}
