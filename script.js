...
const homeText = {
  ...
  zh: {
    work: "作品", games: "游戏", misc: "工具", notes: "笔记", contact: "联系", createEmail: "创建邮箱", mailbox: "邮箱", talk: "聊天", signIn: "登录", signUp: "注册",
    prompt: "请注册或登录", greetings: ["你好，{name}", "欢迎回来，{name}", "今天也开始吧，{name}", "准备好了，{name}", "一起做点东西吧，{name}"], dailyLabel: "每日签到", dailyReady: "今天签到了吗？", dailyDone: "已签到 {count} 天。", dailyButton: "签到", dailyButtonDone: "完成",
    lede: "我做有想法的软件，把点子变成可用的系统，也记录一路学到的东西。",
    mailboxAction: "邮箱", createEmailAction: "创建邮箱", gamesAction: "游戏", miscAction: "工具", talkAction: "聊天", workAction: "查看作品",
  ...
  ja: {
    prompt: "登録またはログインしてください", greetings: ["こんにちは、{name}", "おかえり、{name}", "今日も始めよう、{name}", "準備できています、{name}", "一緒に作ろう、{name}"], dailyLabel: "毎日のチェックイン", dailyReady: "今日はチェックインする？", dailyDone: "{count}日チェックイン済み。", dailyButton: "チェックイン", dailyButtonDone: "完了", work: "作品", games: "ゲーム", misc: "ツール", notes: "ノート", contact: "連絡", createEmail: "メール作成", mailbox: "メール", talk: "トーク", signIn: "ログイン", signUp: "登録",
    lede: "考え抜いたソフトウェアを作り、アイデアを動く仕組みにし、学びを少しずつ記録しています。", mailboxAction: "メール", createEmailAction: "メール作成", gamesAction: "ゲーム", miscAction: "ツール", talkAction: "トーク", workAction: "作品を見る",
  ...
  ko: {
    prompt: "가입하거나 로그인해 주세요", greetings: ["안녕하세요, {name}", "다시 만나 반가워요, {name}", "오늘도 시작해요, {name}", "준비됐어요, {name}", "같이 만들어봐요, {name}"], dailyLabel: "매일 체크인", dailyReady: "오늘 체크인할까요?", dailyDone: "{count}일 체크인했습니다.", dailyButton: "체크인", dailyButtonDone: "완료", work: "작업", games: "게임", misc: "도구", notes: "노트", contact: "연락", createEmail: "메일 만들기", mailbox: "메일함", talk: "대화", signIn: "로그인", signUp: "가입",
    lede: "생각이 담긴 소프트웨어를 만들고, 아이디어를 작동하는 시스템으로 만들며, 배운 것을 조금씩 기록합니다.", mailboxAction: "메일함", createEmailAction: "메일 만들기", gamesAction: "게임", miscAction: "도구", talkAction: "대화", workAction: "작업 보기",
  ...
  es: {
    prompt: "Regístrate o inicia sesión", greetings: ["Hola, {name}", "Qué bueno verte, {name}", "Volvamos a crear, {name}", "Listo cuando tú quieras, {name}", "Buen día, {name}"], dailyLabel: "Check-in diario", dailyReady: "¿Listo para hoy?", dailyDone: "Has hecho check-in {count} días.", dailyButton: "Check-in", dailyButtonDone: "Listo", work: "Trabajo", games: "Juegos", misc: "Herramientas", notes: "Notas", contact: "Contacto", createEmail: "Crear email", mailbox: "Correo", talk: "Chat", signIn: "Entrar", signUp: "Registrarse",
    lede: "Construyo software cuidadoso, convierto ideas en sistemas que funcionan y guardo un pequeño registro de lo que aprendo.", mailboxAction: "Correo", createEmailAction: "Crear email", gamesAction: "Juegos", miscAction: "Herramientas", talkAction: "Chat", workAction: "Ver trabajo",
  ...
  fr: {
    prompt: "Inscrivez-vous ou connectez-vous", greetings: ["Bonjour, {name}", "Content de vous revoir, {name}", "On s’y remet, {name}", "Prêt quand vous l’êtes, {name}", "Bonne journée, {name}"], dailyLabel: "Point du jour", dailyReady: "Prêt pour aujourd’hui ?", dailyDone: "Point du jour fait {count} jours.", dailyButton: "Valider", dailyButtonDone: "Fait", work: "Travail", games: "Jeux", misc: "Outils", notes: "Notes", contact: "Contact", createEmail: "Créer un email", mailbox: "Boîte mail", talk: "Discussion", signIn: "Connexion", signUp: "Inscription",
    lede: "Je crée des logiciels attentifs, transforme des idées en systèmes utilisables, et garde une trace de ce que j'apprends.", mailboxAction: "Boîte mail", createEmailAction: "Créer un email", gamesAction: "Jeux", miscAction: "Outils", talkAction: "Discussion", workAction: "Voir le travail",
  ...
  de: {
    prompt: "Bitte registrieren oder anmelden", greetings: ["Hallo, {name}", "Schön dich zu sehen, {name}", "Bereit für heute, {name}", "Willkommen zurück, {name}", "Lass uns etwas bauen, {name}"], dailyLabel: "Täglicher Check-in", dailyReady: "Bereit für heute?", dailyDone: "Seit {count} Tagen eingecheckt.", dailyButton: "Einchecken", dailyButtonDone: "Fertig", work: "Arbeit", games: "Spiele", misc: "Werkzeuge", notes: "Notizen", contact: "Kontakt", createEmail: "E-Mail erstellen", mailbox: "Postfach", talk: "Chat", signIn: "Anmelden", signUp: "Registrieren",
    lede: "Ich baue durchdachte Software, forme Ideen zu funktionierenden Systemen und halte fest, was ich lerne.", mailboxAction: "Postfach", createEmailAction: "E-Mail erstellen", gamesAction: "Spiele", miscAction: "Werkzeuge", talkAction: "Chat", workAction: "Arbeit ansehen",
  ...
  pt: {
    prompt: "Cadastre-se ou entre", greetings: ["Olá, {name}", "Bom te ver, {name}", "Vamos começar, {name}", "Pronto quando você estiver, {name}", "Vamos criar algo, {name}"], dailyLabel: "Check-in diário", dailyReady: "Pronto para hoje?", dailyDone: "Check-in feito por {count} dias.", dailyButton: "Check-in", dailyButtonDone: "Feito", work: "Trabalho", games: "Jogos", misc: "Ferramentas", notes: "Notas", contact: "Contato", createEmail: "Criar email", mailbox: "Email", talk: "Conversa", signIn: "Entrar", signUp: "Cadastrar",
    lede: "Crio software cuidadoso, transformo ideias em sistemas funcionando e registro o que aprendo pelo caminho.", mailboxAction: "Email", createEmailAction: "Criar email", gamesAction: "Jogos", miscAction: "Ferramentas", talkAction: "Conversa", workAction: "Ver trabalho",
  ...
  ru: {
    prompt: "Зарегистрируйтесь или войдите", greetings: ["Привет, {name}", "Рад видеть вас, {name}", "Начнём день, {name}", "Готово, когда вы готовы, {name}", "Давайте что-нибудь создадим, {name}"], dailyLabel: "Ежедневная отметка", dailyReady: "Готовы к сегодняшнему дню?", dailyDone: "Отмечено дней: {count}.", dailyButton: "Отметиться", dailyButtonDone: "Готово", work: "Работы", games: "Игры", misc: "Инструменты", notes: "Заметки", contact: "Контакт", createEmail: "Создать почту", mailbox: "Почта", talk: "Чат", signIn: "Войти", signUp: "Регистрация",
    lede: "Я создаю продуманный софт, превращаю идеи в рабочие системы и веду небольшой журнал того, чему учусь.", mailboxAction: "Почта", createEmailAction: "Создать почту", gamesAction: "Игры", miscAction: "Инструменты", talkAction: "Чат", workAction: "Смотреть работы",
  ...
  ar: {
    prompt: "يرجى التسجيل أو تسجيل الدخول", greetings: ["مرحبا، {name}", "سعيد برؤيتك، {name}", "لنبدأ اليوم، {name}", "جاهز عندما تكون جاهزا، {name}", "لنصنع شيئا، {name}"], dailyLabel: "تسجيل يومي", dailyReady: "هل أنت جاهز لليوم؟", dailyDone: "تم التسجيل {count} أيام.", dailyButton: "تسجيل", dailyButtonDone: "تم", work: "الأعمال", games: "الألعاب", misc: "أدوات", notes: "ملاحظات", contact: "تواصل", createEmail: "إنشاء بريد", mailbox: "البريد", talk: "الدردشة", signIn: "دخول", signUp: "تسجيل",
    lede: "أبني برمجيات مدروسة، وأحوّل الأفكار إلى أنظمة تعمل، وأسجل ما أتعلمه بهدوء.", mailboxAction: "البريد", createEmailAction: "إنشاء بريد", gamesAction: "الألعاب", miscAction: "أدوات", talkAction: "الدردشة", workAction: "عرض الأعمال",
...
function checkinKey() {
  return currentCheckinUserKey ? `muye-daily-checkin:${currentCheckinUserKey}` : "";
}
...
function loadCheckinRecord() {
  ...
  try {
    ...
    return { days: Array.isArray(record.days) ? record.days : [] };
  } catch {
    return { days: [] };
  }
}
...
function saveCheckinRecord(record) {
  const key = checkinKey();
  if (!key) return;
  const days = [...new Set(record.days || [])].sort();
  localStorage.setItem(key, JSON.stringify({ days, last: days.at(-1) || "" }));
}

function countText(template, count) {
  return String(template || "").replace("{count}", String(count));
}

function syncDailyCheckin() {
  if (!dailyCheckin || !dailyCheckinLabel || !dailyCheckinStatus || !dailyCheckinButton) return;
  if (!currentCheckinUserKey) {
    dailyCheckin.hidden = true;
    dailyCheckinButton.disabled = true;
    return;
  }
  dailyCheckin.hidden = false;
  const record = loadCheckinRecord();
  const done = record.days.includes(todayKey());
  const count = record.days.length;
  dailyCheckinLabel.textContent = textFor("dailyLabel");
  dailyCheckinStatus.textContent = count ? countText(textFor("dailyDone"), count) : textFor("dailyReady");
...
dailyCheckinButton?.addEventListener("click", () => {
  if (!currentCheckinUserKey) return;
  const record = loadCheckinRecord();
  if (!record.days.includes(todayKey())) record.days.push(todayKey());
