...
const homeText = {
  ...
  ko: {
    prompt: "가입하거나 로그인해 주세요", greetings: ["안녕하세요, {name}", "다시 만나 반가워요, {name}", "오늘도 시작해요, {name}", "준비됐어요, {name}", "같이 만들어봐요, {name}"], dailyLabel: "매일 체크인", dailyReady: "오늘 체크인할까요?", dailyDone: "{count}일 체크인했습니다.", dailyButton: "체크인", dailyButtonDone: "완료", work: "작업", games: "게임", misc: "기타", notes: "노트", contact: "연락", createEmail: "메일 만들기", mailbox: "메일함", talk: "대화", signIn: "로그인", signUp: "가입",
